...
def start_fab(fab, configuration_data, requested_items):
    ...
    try:
        ...
        fab_search_response = FabLoopFactory(loop_type).get_fab_loop().start_loop(fab, configuration_data, requested_items, user_filters)
        ...
        if not check_if_restart_is_possible(fab):
            ...
            return start_fab(fab, configuration_data, requested_items)
